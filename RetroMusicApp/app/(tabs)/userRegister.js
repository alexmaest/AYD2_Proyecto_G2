...
const RegisterForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const regEndpoint = apiUrls.auth.userRegister
      console.log(baseUrl + regEndpoint)
  ...
  return (
    <SafeAreaView className='flex-1 items-center justify-center bg-retro-black text-retro-white'>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1 }}>
        ...
        <Text className='text-retro-white font-bold text-[18px]' style={{ textAlign: 'center' }}>Sign up free to start listening.</Text>
